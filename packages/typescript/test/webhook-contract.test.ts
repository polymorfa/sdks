  ...
  "bansafe.risk_changed": shape<P["bansafe.risk_changed"]>()(
    {
      ...
      previousLevel: "low",
      score: 37,
      forecast: { days7: 0.02, days14: 0.05, days30: 0.09 },
      factors: [
        {
          key: "volume.daily_send_rate",
          group: "volume",
          label: "Daily send rate",
          direction: "raises",
          strength: "moderate",
          impact: 12,
          sentence: "This number sends more than usual for its age.",
          hint: "Spread sends across the day.",
        },
      ],
      model: { version: "2026-09-01", reliability: "calibrated" },
      evaluatedAt: AT,
    },
    [
      "phoneNumber",
