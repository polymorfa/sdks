  ...
  it("packs and imports in a clean consumer without runtime dependencies", () => {
    ...
    writeFileSync(
      ...
      [
        ...
        'const platform = new Client({ credential: { type: "organizationApiKey", value: "pmfa_fixture" } });',
        'const project = platform.project("project_123");',
        "const system = new SystemClient();",
        'const bridge = new BridgeClient({ credential: { type: "projectToken", value: "pmfa_pt_fixture" } });',
