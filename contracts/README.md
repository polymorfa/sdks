...
`a3ae8546f3dc090052aee2b8b68c62ac169e10b2`, folded together with the calls-folding
and SIP trunk operations from the pushed-but-not-yet-merged branch
`t3code/calls-unified-5-client-diagnostics` (commit
`1681cdaa96c2625220c32fc3a912b380179fa9ee`); re-pin to one merged commit before
release. `source.json` records their original paths and SHA-256 hashes.
