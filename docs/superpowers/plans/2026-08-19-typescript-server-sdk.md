...
- The contract source is monorepo commit `5475b869a953d87ae39a94cdfb1e4be2cd3f4f0c`, Messaging path `apps/api/docs/openapi.json`, Platform path `apps/api/docs/openapi.management.json`.
